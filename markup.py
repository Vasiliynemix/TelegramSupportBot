...
def markup_end_reqs():
    markup_end_reqs = types.ReplyKeyboardMarkup(resize_keyboard=True)
    item1 = types.KeyboardButton("Завершить запрос")
    markup_end_reqs.add(item1)

    return markup_end_reqs
